    ...
    <main className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors duration-500">
      ...
      <section id="nosotros" className={`flex flex-col items-center justify-center px-5 py-16 md:min-h-[85vh] md:py-0 text-center transition-colors duration-700 ${colors.bg}`}>
        <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
          ...
          <h1 className="text-4xl md:text-8xl lg:text-9xl font-black text-gray-900 dark:text-white tracking-tighter leading-[1.1] md:leading-none">
          ...
          <p className="text-base md:text-2xl text-gray-600 dark:text-gray-400 max-w-sm md:max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col w-full md:w-auto md:flex-row gap-3 md:gap-6 justify-center pt-4 md:pt-8 px-2 md:px-0">
            <a href="#calculadora" className={`${colors.secondary} text-white w-full md:w-auto px-8 py-4 rounded-2xl font-black text-sm md:text-lg shadow-xl active:scale-95 transition-all flex items-center justify-center`}>
              CALCULAR TURNO
            </a>
            <SignedOut>
              <SignInButton mode="modal">
                <button className="bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white w-full md:w-auto border-2 border-gray-900 dark:border-white px-8 py-4 rounded-2xl font-black text-sm md:text-lg hover:bg-gray-900 dark:hover:bg-white hover:text-white dark:hover:text-black transition-all">
                  INGRESAR Y VER TUS NÓMINAS
                </button>
              </SignInButton>
            </SignedOut>
            <SignedIn>
              <Link href="/nominas" className="bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white w-full md:w-auto border-2 border-gray-900 dark:border-white px-8 py-4 rounded-2xl font-black text-sm md:text-lg hover:shadow-xl transition-all flex items-center justify-center">
                📂 MIS NÓMINAS
              </Link>
            </SignedIn>
          </div>
