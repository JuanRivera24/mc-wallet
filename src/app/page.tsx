      ...
      <section id="nosotros" className={`flex flex-col items-center justify-center px-5 py-16 md:min-h-[85vh] md:py-0 text-center transition-colors duration-700 ${colors.bg}`}>
        <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
          ...
          <div className="flex flex-col w-full md:w-auto md:flex-row gap-3 md:gap-6 justify-center pt-4 md:pt-8 px-2 md:px-0">
            ...
            <SignedIn>
              <Link href="/nominas" className="bg-white text-gray-900 w-full md:w-auto border-2 border-gray-900 px-8 py-4 rounded-2xl font-black text-sm md:text-lg hover:shadow-xl transition-all flex items-center justify-center">
                📂 MIS NÓMINAS
              </Link>
            </SignedIn>
          </div>
      ...
      <section id="calculadora" className="py-16 md:py-24 bg-gray-50 flex flex-col items-center px-4">
        <div className="mb-8 md:mb-12 text-center max-w-lg mx-auto">
          ...
          <p className="text-gray-400 font-bold text-xs md:text-sm">
            Calcula sin necesidad de guardar. - <b className="text-gray-600">Inicia sesión para guardar tus turnos y estimar tus nóminas</b>
          </p>
        </div>
        
        <ShiftCalculator />

        {/* BOTONES DEBAJO DE LA CALCULADORA */}
        <div className="mt-6 w-full max-w-lg flex flex-col gap-3">
          <SignedOut>
            <SignInButton mode="modal">
              <button className="bg-gray-900 text-white w-full px-8 py-4 rounded-2xl font-black text-sm md:text-lg hover:bg-black hover:scale-[1.02] active:scale-95 transition-all shadow-xl">
          ...
          <SignedIn>
            <Link href="/nominas" className="bg-gray-900 text-white w-full px-8 py-4 rounded-2xl font-black text-sm md:text-lg hover:bg-black hover:scale-[1.02] active:scale-95 transition-all shadow-xl text-center block">
              📂 IR A MIS NÓMINAS
            </Link>
          </SignedIn>
        </div>
